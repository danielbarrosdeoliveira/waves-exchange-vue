...
export default {
  ...
  setup() {
    ...
    async function getPriceETH() {
      fetch(
        'https://cors-anywhere.herokuapp.com/https://api.nomics.com/v1/currencies/ticker?key=4abbb7e7592df4f53bb67052d7ec165d4cf677f2&ids=BTC,ETH,XRP&interval=1h&convert=USD&platform-currency=ETH&per-page=10&page=1'
      )
